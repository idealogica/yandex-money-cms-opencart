...
$_['entry_mode3']         = 'На расчетный счет организации с заключением договора с Яндекс.Деньгами с выбором оплаты на стороне Яндекс.Кассы';
$_['entry_paymode']         = '<b>Внимание! Этот режим должен быть включен и на стороне сервиса Яндекс.Касса.</b><br>
				Чтобы активировать этот сценарий, напишите менеджеру Кассы на <a href="mailto:merchants@yamoney.ru">merchants@yamoney.ru</a> или позвоните по телефону 8 800 250-66-99.';
