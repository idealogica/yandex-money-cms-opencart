### xx.xx.2016
* Рефакторинг
* Добавление в ЛК покупателя возможности оплатить повторно
* Настройка перехода на собственную страницу успеха/отказа
* Добавление проверки суммы платежа со стороны модуля
* Устанавливать статус заказа по настройкам модуля (Статус по умолчанию, Промежуточный, Конечный) 
* Добавить метод оплаты по умолчанию.
